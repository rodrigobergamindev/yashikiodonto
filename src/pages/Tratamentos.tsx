import {Container, Description, DescHeader, ContainerBody, Desc, TextContainer, Bar,
    ContainerProfissionais, CardProfissional, ContainerCards, ContainerTratamentos, CardTratamento} from '../styles/styles.tratamentos'
        ...
        return (
            ...
            <Container>
                ...
                <Description>
                    <DescHeader>    
                        <h1>TRATAMENTOS</h1>
                        <h4>Possuimos uma ampla variedade de tratamentos e um corpo clínico especializado e pronto para atender as suas necessidades!</h4>
