...
const Navbar = () => {
  return (
    <Nav>
      ...
      <Burger />
    <SocialMediaList>
      <li><a href="https://www.instagram.com/lojinha_da_mayumi/" target="_blank"><img src="/img/instagram.png"/></a></li>
      <li><a href="https://vm.tiktok.com/ZMegKPN55/" target="_blank"><img src="/img/tiktok.png"/></a></li>
